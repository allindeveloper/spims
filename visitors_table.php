...
<div class="wrapper">
 ...
 <div class="col-md-12">
                <div class="row">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_new_visitors_item_modal">New Item(Clock-In)</button> 
                
                <br><br>       
                <div class="card">
                            <div class="header">
                                <h4 class="title">All Visitors Data</h4>
                                <p class="category">Here is a table showing all visitors, items brought and other informations.</p>
                            </div>
                            <div class="visitors_records_content"></div>
...
<div class="modal fade" id="add_new_visitors_item_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Add New Item (Visitors)</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addvisitorsRecord()">Add Record</button>
            </div>
        </div>
    </div>
</div>
<!-- Real Add Admin -->
                            ...
                            <!-- Visitors Checkout Update -->
   <div class="modal fade" id="update_visitors_item_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="UpdateVisitorsDetails()" >Save Changes</button>
    ...
    <script src="js/visitorslogic.js"></script>
