...
<div class="wrapper">
 ...
 <div class="col-md-12">
                <div class="row">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_new_staff_item_modal">New Item(Clock-In)</button> 
                
                <br><br>       
                <div class="card">
                            <div class="header">
                                <h4 class="title">All Staff Data</h4>
                                <p class="category">Here is a table showing all staff, items brought and other informations.</p>
                            </div>
                            <div class="staff_records_content"></div>
...
<div class="modal fade" id="add_new_staff_item_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Add New Item (Staff)</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addstaffRecord()">Add Record</button>
            </div>
        </div>
    </div>
</div>
<!-- Real Add Admin -->
                            ...
                            <!-- Staff Checkout Update -->
                            <div class="modal fade" id="update_staff_item_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <script src="js/stafflogic.js"></script>
