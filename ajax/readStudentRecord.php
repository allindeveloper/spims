    ...
    function nicetime($date)
{
    ...
    if(mysqli_num_rows($result) > 0)
    {
    	...
    	while($row = mysqli_fetch_array($result))
    	{
    		...
    		$data .= '<tr>
                ...
                <td>
					<button onclick="GetStudentDetails('.$row['student_id'].')" class="btn btn-danger">More</button>
				</td>
    ...
    {
    	// records now found 
    	$data .= '<tr><td colspan="6">No Student Items Yet!</td></tr>';
    }
